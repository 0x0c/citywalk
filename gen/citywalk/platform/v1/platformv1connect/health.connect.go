...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/0x0c/citywalk/gen/citywalk/platform/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "citywalk.platform.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/citywalk.platform.v1.HealthService/Check"
)

// HealthServiceClient is a client for the citywalk.platform.v1.HealthService service.
type HealthServiceClient interface {
	// Check reports whether the process is ready to serve traffic.
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the citywalk.platform.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_citywalk_platform_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls citywalk.platform.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the citywalk.platform.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/citywalk.platform.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("citywalk.platform.v1.HealthService.Check is not implemented"))
}
